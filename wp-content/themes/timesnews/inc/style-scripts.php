...
function timesnews_scripts() {
	...
	wp_enqueue_style( 'timesnews-google-fonts', wptt_get_webfont_url(timesnews_fonts_url()), array(), null );
	...
	if($slider_options !='main-banner'){
		...
		if ($disable_main_banner ==1){
			...
			// Silence is Golden
				...
				wp_enqueue_script( 'timesnews-slick-banner-settings', get_template_directory_uri() . '/assets/library/slick/slick-banner-settings.js', array(), false, true );
