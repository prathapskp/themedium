...
printf( esc_html__( 'Theme: %1$s By %2$s.', 'timesnews' ), __('TimesNews <span class="sep"> | </span> ','timesnews'),'<a href="'.esc_url('https://themefreesia.com/') .'">' . esc_html__('Theme Freesia','timesnews').'</a>' );
}
