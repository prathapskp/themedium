	...
	<div class="col-left">
		<div class="intro">
			<h3><?php /* translators: %s theme name */
				...
				?></p>
				<p> &nbsp;</p>
				<a href="<?php echo esc_url('https://demo.themefreesia.com/timesnews'); ?>" class="button button-primary button-hero about-theme" target="_blank"><?php esc_html_e( 'Visit Free Demo', 'timesnews' ); ?></a> &nbsp; <a href="<?php echo esc_url('https://demo.themefreesia.com/timesnews-pro'); ?>" class="button button-primary button-hero about-theme" target="_blank"><?php esc_html_e( 'Visit Plus Demo', 'timesnews' ); ?></a>
		</div>
		<div class="theme-tabs">
			...
			<label for="five" class="tab-label"><?php esc_html_e('Plus Features','timesnews');?></label>

			<article class="content one">
			    <h3><?php esc_html_e('About Documentation','timesnews');?></h3>
			    <p><?php esc_html_e('Documentation is the information that describes the product to its users. Our documentation covers only related to Free Themes and Plus Extension Plugins. It will guide your to develop your Website as we displayed in demo site without any others help.','timesnews');?></p>
			    <p>
					<a href="<?php echo esc_url('https://themefreesia.com/theme-instruction/timesnews/');?>" target="_blank" class="button button-primary"><?php printf( esc_html__( '%s Documentation', 'timesnews' ), esc_html( $theme->Name ) ); ?></a>
				</p>
			   ...
			   <p><?php esc_html_e('Want to know more about Themes and Plugins developed by Theme Freesia? ','timesnews'); ?><a href="<?php echo esc_url('https://themefreesia.com/frequently-asked-questions/');?>" class="button button-primary" target="_blank"><?php esc_html_e('F.A.Q','timesnews');?></a></p>
			...
			<article class="content two">
				...
				<p><?php esc_html_e('Do you want to install One Click Demo Import Plugin? ','timesnews'); ?></p>
					<a href="https://themefreesia.com/theme-freesia-demo-import/" target="_blank" class="button button-primary" style="text-decoration: none;">
						<?php esc_html_e( 'Download Dummy Plugin', 'timesnews' ); ?>
					</a>
					 &nbsp;&nbsp;
			...
			<article class="content three">
			   <h3><?php esc_html_e('About Support','timesnews');?></h3>
				<p><?php esc_html_e('Need Help? Use our Forums if you have any Themes and Plugins related questions. Support will be provided only related to our Themes and Plugins','timesnews');?>
					<a href="<?php echo esc_url('https://themefreesia.com/support-forum/'); ?>" target="_blank" class="button button-primary"> <?php esc_html_e('Plus Forum','timesnews');?></a> <a href="<?php echo esc_url('https://tickets.themefreesia.com/'); ?>" target="_blank" class="button button-primary"> <?php esc_html_e('Free Tickets','timesnews');?></a>
				</p>
				...
				<p><?php esc_html_e('Do you have discussion relating to billing, your account or have pre-sales questions? Get touch with us!','timesnews');?>
					<a href="<?php echo esc_url('https://themefreesia.com/contact-us/');?>" target="_blank" class="button button-primary"> <?php esc_html_e('Contact us','timesnews');?></a>
				</p>
			   <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/screenshot.png">
			</article>
			...
			<article class="content five">
				 <h3><?php esc_html_e('Upgrade to Plus','timesnews');?></h3>
				 <p><?php esc_html_e('Want additional features? Plus extension plugin adds additinal features for free themes. ','timesnews')?><a href="<?php echo esc_url('https://themefreesia.com/themes/timesnews');?>" class="button button-primary button-hero" target="_blank"><?php esc_html_e('Upgrade to Plus','timesnews');?></a></p>
			   <h3><?php esc_html_e('Plus Features Extension','timesnews');?></h3>
		...
		<div class="pro-content">
			<div class="pro-content-wrap">
				<div class="pro-content-header">
					<h3><?php esc_html_e('Powerful Plus Extension Features','timesnews');?></h3>
					<p><?php esc_html_e('Get unlimited features using Plus extension. Purchase TimesNews Plus extension and get additional features and advanced customization options to make your website look awesome in different styles. ','timesnews'); ?></p>
				</div>
					<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/free_vs_pro.png" alt="<?php esc_attr_e('Free vs Plus','timesnews');?>">
			</div>
		</div>
	</div>
</div>
